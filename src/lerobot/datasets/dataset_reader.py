...
class DatasetReader:
    ...
    def _load_hf_dataset(self) -> datasets.Dataset:
        ...
        # Some ecosystem v2.1 datasets contain auxiliary parquet columns that were not
        # declared in info.json. Let Arrow infer that legacy schema instead of rejecting
        # otherwise readable data. v3 datasets retain strict metadata validation.
        features = None if self._meta.is_legacy_v21 else get_hf_features_from_features(self._meta.features)
