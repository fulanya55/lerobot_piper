...
from .wire import deserialize_policy_config, deserialize_timed_observation, serialize_timed_actions
...
class PolicyServer(services_pb2_grpc.AsyncInferenceServicer):
    ...
    def _load_policy(self, policy_specs, policy_key) -> None:
        ...
        # Preserve the rename map stored in the checkpoint unless the robot client
    ...
    def SendObservations(self, request_iterator, context):  # noqa: N802
        ...
        timed_observation = deserialize_timed_observation(received_bytes)
    ...
    def GetActions(self, request, context):  # noqa: N802
        ...
        try:
            ...
            start_time = time.perf_counter()
            actions_bytes = serialize_timed_actions(action_chunk)
